...
> invenciones.
>
> [Marcadores de esta versión: los campos con «⟨por confirmar⟩» son datos que
> solo tú puedes rellenar o validar. Los repos marcados «⟨pendiente de
> publicar⟩» aún no son públicos en GitHub. Fuente canónica de experiencia y
> formación: LinkedIn (jul 2026).]
...
- Estado (en curso / finalizado / % completado): en curso
- Contenido clave / asignaturas relevantes: Machine Learning, Python para análisis de datos, Data Analytics, IA aplicada, procesamiento y visualización de datos, SQL y modelado de data warehouses
- Proyecto o trabajo destacado: EDAFatalForce (análisis exploratorio avanzado) y Data Warehouse Olist (modelado dimensional en PostgreSQL) — ver sección 5
- Nota o distinción (si aplica y ayuda): ⟨por confirmar⟩
...
- Estado: finalizando · proyecto final (RondaGuide) defendido ante tribunal
- Contenido clave: desarrollo web frontend y backend, programación orientada a objetos (Java), entornos de desarrollo, bases de datos relacionales (MySQL)
- Proyecto destacado: RondaGuide — aplicación web turística de Ronda (proyecto final de ciclo) — ver sección 5
...
- Fechas: 2017 – 2018
- Relevancia: capacidad pedagógica y de comunicación (formación y onboarding de agentes en C3i); especialidad en francés que respalda su nivel C1.

### [id: edu_grado_traduccion]
- Titulación: Grado en Traducción e Interpretación
- Centro: Universidad de Málaga
- Fechas: 2016
- Relevancia: base de su perfil multilingüe (EN C1, FR C1, PT B2) y de su precisión con el lenguaje y la documentación técnica; fundamento de sus 5 años de soporte multilingüe.
...
- ICH Good Clinical Practice E6(R2) — Global Health Training Centre — 2020 ⟨enlace de verificación si lo tienes⟩
- Acreditación de examinadores DELE B1-B2 (Par-649-17) — Instituto Cervantes — abr. 2017 — ID de credencial: 856247
-
...
- Descripción en 1 frase: gestión y resolución de escalados de Tier 1 y peticiones directas del cliente para la solución ePID de Novo Nordisk.
- Responsabilidades:
  - Resolvió escalados de Tier 1 y peticiones directas del cliente; cuando la incidencia no podía resolverse en soporte, la coordinaba con las áreas correspondientes.
  - Trabajó con Azure, CRM y workflows corporativos basados en SOPs; elaboró documentación técnica y reporting operativo.
  - Realizó seguimiento de KPIs y coordinación con equipos internacionales; comunicación con stakeholders.
- Logros CUANTIFICADOS: ⟨por confirmar⟩
- Stack / herramientas usadas: Azure, CRM corporativo, Jira, Excel avanzado, workflows SOP
...
- Descripción en 1 frase: responsable de la formación y el desarrollo de los agentes, tareas de supervisión y aseguramiento de la calidad para las soluciones de software de Pfizer.
- Responsabilidades:
  - Dirigió la formación y el desarrollo (training & development) de los agentes del proyecto.
  - Ejecutó tareas de supervisión y aseguramiento de la calidad (QA) del servicio.
  - Analizó métricas y SLAs; reporting y soporte a la dirección.
- Logros CUANTIFICADOS: ⟨por confirmar: tamaño del equipo, mejoras de calidad/SLA⟩
- Stack / herramientas usadas: Azure, CRM, Jira, Excel avanzado, herramientas de reporting
...
- Descripción en 1 frase: responsable del entrenamiento de agentes y del control de calidad, supervisión y revisión de procedimientos en aplicaciones de ensayos clínicos.
- Responsabilidades:
  - Encargado del entrenamiento de agentes para asistencia técnica en distintas aplicaciones de ensayos clínicos.
  - Responsable de control de calidad, supervisión y revisión de los procedimientos internos.
  - Coordinó incidencias escaladas de alto impacto con equipos internacionales.
- Logros CUANTIFICADOS: ⟨por confirmar⟩
- Stack / herramientas usadas: CRM, Jira, workflows corporativos
...
- Modalidad: jornada completa · presencial — Sofía, Bulgaria
- Descripción en 1 frase: soporte técnico senior a usuarios de plataformas y software de ensayos clínicos de Pfizer.
- Responsabilidades:
  - Prestó soporte técnico senior a usuarios de las plataformas de Pfizer.
  - Registró, priorizó y resolvió incidencias con trazabilidad; documentación y reportes.
  - Colaboró con equipos internacionales de QA y desarrollo.
- Logros CUANTIFICADOS: ⟨por confirmar⟩
- Stack / herramientas usadas: CRM, plataformas eClinical de Pfizer, herramientas de ticketing
...
- Modalidad: jornada completa · presencial — Sofía, Bulgaria
- Descripción en 1 frase: soporte técnico a usuarios de plataformas y software de ensayos clínicos de Pfizer.
- Responsabilidades:
  - Atendió y resolvió incidencias de usuarios de las plataformas de Pfizer (llamadas, correos y chat).
  - Documentó casos y generó reportes.
  - Trabajó en inglés, francés y portugués con usuarios y equipos internacionales.
- Logros CUANTIFICADOS: ⟨por confirmar⟩
- Stack / herramientas usadas: CRM, plataformas eClinical de Pfizer
...
- Descripción en 1 frase: agente de asistencia técnica de software y aplicaciones para Medidata, atendiendo a usuarios involucrados en ensayos clínicos.
- Responsabilidades:
  - Atendió llamadas, correos y sesiones de chat de usuarios de las aplicaciones de Medidata (p. ej. Medidata Rave) en ensayos clínicos.
  - Registró y resolvió incidencias en varios idiomas (inglés, francés, portugués).
  - Documentó casos y colaboró con equipos globales.
- Logros CUANTIFICADOS: ⟨por confirmar⟩
- Stack / herramientas usadas: CRM, Medidata Rave, herramientas de ticketing
...
- Descripción en 1 frase: docencia de español y creación de material didáctico en Francia, apoyo en exámenes oficiales DELE, y traducción/revisión voluntaria de textos para ONG.
- Responsabilidades:
  - Enseñanza de español a alumnos de secundaria y bachillerato bajo supervisión del profesor titular; creación de material didáctico para la competencia oral.
  - Profesor en la convocatoria oficial de exámenes DELE (Instituto Cervantes, París).
  - Traducción y corrección voluntaria de textos para ONG y asociaciones sin ánimo de lucro (PerMondo).
- Stack / herramientas usadas: —
- Relevancia: inmersión en entorno francófono (respalda FR C1); experiencia docente y de comunicación.
...
- Una frase de qué es: almacén de datos analítico sobre el dataset de e-commerce brasileño Olist, con esquema en estrella en PostgreSQL.
- Tu rol exacto: diseño e implementación individual (proyecto del Máster en Data Science, Evolve Academy).
- Problema que resolvía: transformar datos transaccionales crudos de Olist en un modelo dimensional consultable para obtener KPIs de negocio.
- Qué construiste (arquitectura, decisiones técnicas): esquema en estrella con 5 dimensiones y 1 tabla de hechos, con claves, índices, vistas y una función requerida; proceso ETL auditado en dos pasadas completas; corrección de una discrepancia de nombres de columna causada por una errata histórica en los CSV de Olist; resolución de una incoherencia entre el diagrama ER y el esquema.
- Reto técnico concreto superado (el "war story"): un INSERT en la tabla de hechos se colgaba de forma indefinida. Diagnosticó que la causa eran estadísticas obsoletas del planificador de PostgreSQL y lo resolvió añadiendo ANALYZE sobre las cinco dimensiones a mitad de transacción en 02_data.sql.
- Resultado / métricas verificables: KPIs verificados; entregó documentación de auditoría y una guía de defensa (AUDITORIA.md). ⟨métricas numéricas concretas por añadir si las tienes⟩
- Stack: PostgreSQL, SQL, modelado dimensional (esquema estrella), DBeaver, Git/GitHub.
- Enlace repo / demo: https://github.com/dnarram/olist-ecommerce-datawarehouse
- ¿Defendido ante tribunal / evaluado? Nota: proyecto evaluado del máster; preparó auditoría y guía de defensa (AUDITORIA.md).
- Artículo relacionado: "Tres decisiones técnicas que habrían falsificado mi informe de negocio" (LinkedIn) — ver Extras.

### [id: proj_edafatalforce]  — EDA Fatal Force
- Nombre: EDAFatalForce — Análisis exploratorio de la base Fatal Force
- Una frase: análisis exploratorio de la base Fatal Force del Washington Post (2015-2024), enriquecida con el censo ACS 2020 y datos de bodycams de la NCSL.
- Tu rol: individual (proyecto del Máster en Data Science, Evolve Academy).
- Problema / pregunta de análisis: analizar los datos de uso de fuerza letal policial en EE. UU., corrigiendo miscodificaciones del dataset y aportando contexto socioeconómico.
- Qué hiciste (limpieza, correcciones, hallazgos): corrigió errores críticos en features.py (miscodificación de flee_status y etiquetado erróneo de armed_with) y la imputación de condados en cleaning.py; verificó todas las correcciones contra el CSV crudo; entregó eda.ipynb corregido, README, análisis narrativo, artículos adaptados por plataforma y un fondo para PowerPoint.
- Reto técnico concreto: las miscodificaciones afectaban a miles de filas; el reto fue detectarlas y corregirlas garantizando la trazabilidad frente a los datos originales.
- Resultado / hallazgos clave: dataset corregido y verificado, con análisis narrativo comunicable a distintas audiencias. ⟨hallazgos concretos por destacar si quieres⟩
- Stack: Python, pandas, Jupyter, EDA; fuentes ACS 2020 Census y NCSL.
- Enlace: ⟨pendiente de publicar⟩
- Artículo relacionado: "Lo que aprendí analizando 10 años de violencia policial en EE.UU. — y por qué los datos sin contexto mienten" (LinkedIn) — ver Extras.

### [id: proj_rondaguide]  — RondaGuide
- Nombre: RondaGuide — Guía web turística de Ronda
- Una frase: aplicación web turística interactiva de Ronda con arquitectura de doble servidor tras NGINX (proyecto final del ciclo DAW, Ilerna).
- Tu rol: individual (proyecto final de ciclo).
- Qué construiste: arquitectura de doble servidor (Node.js/Express + servidor HTTP en Java) tras NGINX, base de datos MySQL, mapas interactivos con Leaflet y frontend en HTML/CSS/JS.
- Reto técnico: auditoría técnica completa que corrigió desincronización de esquema, un desajuste de tipo en una clave foránea, datos semilla ausentes y credenciales expuestas; logró un despliegue full-stack limpio en local (Mac). En la defensa se señaló como punto débil que la arquitectura de doble servidor carecía de una explicación clara del enrutado por petición.
- Resultado: despliegue full-stack funcional y defensa ante tribunal.
- Stack: Node.js, Express, Java (HttpServer), NGINX, MySQL, Leaflet, HTML/CSS/JS.
- Enlace: ⟨pendiente de publicar⟩
- ¿Defendido ante tribunal? Nota: sí, defendido ante el tribunal del ciclo DAW (Ilerna).

### [id: proj_portfolio]  — Portfolio Adaptativo (este proyecto)
- Nombre: Portfolio Adaptativo DNR
- Una frase: portfolio web que recompila su contenido, narrativa y orden de proyectos según el tipo de visitante (HR, tech recruiter, developer, curioso), con un concierge de IA integrado.
...
- Stack: Next.js 15 (App Router), TypeScript, Vercel, Groq API, analítica cookieless.
- Enlace: https://dnr-portfolio-omega.vercel.app
...
> [Niveles anclados a tus propios CVs; ajusta si tu criterio actual difiere.]

### [id: skill_lenguajes]
- Lenguajes: Python — inicial-intermedio orientado a Data Science; SQL — intermedio (modelado dimensional y data warehouse en proyectos reales); Java SE — básico-intermedio (POO, proyecto RondaGuide); JavaScript / TypeScript — intermedio (proyectos web desplegados)

### [id: skill_datos]
- Datos / IA: pandas, NumPy, ETL, análisis exploratorio (EDA), limpieza y transformación de datos, visualización de datos, fundamentos de Machine Learning e IA aplicada, modelado dimensional (esquema en estrella), PostgreSQL, MySQL, Jupyter, DBeaver, KPIs y reporting operativo

### [id: skill_web]
- Desarrollo web: HTML5, CSS3, JavaScript, Node.js, Express, Next.js 15, React, TypeScript, NGINX, Leaflet, fundamentos de APIs REST, conocimientos básicos de Spring Boot y Maven

### [id: skill_herramientas]
- Herramientas / entornos: Git, GitHub, DBeaver, VS Code, Vercel, Excel avanzado, Azure, Jira, Microsoft Project, CRM corporativos, workflows empresariales y documentación técnica

### [id: skill_blandas]
> Soft skills, pero con evidencia. No "trabajo en equipo" a secas, sino
> "defendí RondaGuide ante tribunal" (comunicación técnica).
- Liderazgo y formación de equipos: como Team Lead y Supervisor/SME en C3i, dirigió el entrenamiento y desarrollo de agentes y la revisión de procedimientos (abr 2021 – may 2023).
- Comunicación técnica multilingüe: soporte y coordinación en inglés, francés y portugués con equipos internacionales; defendió el proyecto RondaGuide ante tribunal; autor de artículos técnicos divulgativos.
- Rigor y trazabilidad: mantuvo registros audit-ready bajo SOPs en entorno de ensayos clínicos; audita sus datos contra las fuentes crudas (Olist, EDAFatalForce).
- Depuración sistemática: análisis de causa raíz como práctica profesional (Tier 2) y técnica (bloqueo de INSERT por estadísticas del planificador; correcciones de miscodificación a escala de miles de filas).
- Autonomía extremo a extremo: proyectos técnicos llevados solo desde el diseño hasta el despliegue.

---

## 7. IDIOMAS  [id: idiomas]
- Español: nativo
- Inglés: C1 (5+ años de entorno de trabajo profesional en inglés)
- Otros: Francés — C1 (Grado en Traducción, máster con especialidad en francés, año trabajando en Francia); Portugués — B2
...
- Modalidad preferida: remoto o híbrido; abierto a presencial y relocalización
- Expectativa salarial (normalmente NO en el CV; para tu control): ⟨privado⟩
- Disponibilidad para viajar / relocalización: sí, disponible para relocalización
...
- "Tres decisiones técnicas que habrían falsificado mi informe de negocio" — LinkedIn. Sobre la fragilidad de los datos a partir del data warehouse de +100.000 pedidos (proyecto Olist).
- "Lo que aprendí analizando 10 años de violencia policial en EE.UU. — y por qué los datos sin contexto mienten" — LinkedIn. Sobre el proyecto EDAFatalForce.

### Otros  [id: extras_otros]
- Marca personal propia (DNR) con manual de identidad, aplicada a portfolio web y perfiles profesionales.
- Perfil multilingüe con formación universitaria en Traducción e Interpretación: precisión lingüística aplicada a documentación técnica en 4 idiomas.
- Experiencia internacional: 5 años viviendo y trabajando en Sofía (Bulgaria) en proyectos globales, y una etapa previa en Francia.

---

## NOTAS DE USO (no forma parte del CV)
- Para el CHAT: el sistema usa este documento como contexto. Cuanto más
  completo y exacto, mejores respuestas y menos "no lo sé".
- Para el CV ADAPTADO: cada bloque [id] es una unidad. La idea es que la IA
  seleccione IDs relevantes por vacante (ej. para un puesto de datos:
  resumen_tech + edu_master_datascience + proj_olist + proj_edafatalforce +
  skill_lenguajes + skill_datos), y tu código ensamble el PDF con el TEXTO
  EXACTO de esos bloques. La IA elige, no redacta.
- Para un puesto en FARMA/CLINICAL, activa: exp_c3i_* + certs (ICH GCP) +
  skill_datos — tu combinación de dominio clínico + datos es un diferenciador.
- Mantén este archivo en el repo (ej. /content/cv-maestro.md) y actualízalo
  como cualquier otro contenido: editar → commit → push.
